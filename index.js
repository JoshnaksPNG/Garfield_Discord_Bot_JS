...
client.on("interactionCreate", async interaction =>
{
    ...
    switch (interaction.commandName)
    {
        ...
        case 'generate':
            ...
            let comicPath = await newComic(await randomWeekday(), await randomWeekday(), await randomWeekday());
        ...
        case 'make-pipe-random':
            ...
            let pipeRandomPath = await newComic(await randomWeekday(), await randomWeekday(), await getGarfield(new Date(1978, 6, 27)));
        ...
        case 'make-pipe':
            ...
            let pipePath = await newComic(pipedImg, pipedImg, await getGarfield(new Date(1978, 6, 27)));
        ...
        case 'make-window-random':
            ...
            let windowPath = await newComic(await randomWeekday(), await randomWeekday(), "C:\\git\\GARFIELD\\window.jpg");
        ...
        case 'make-window':
            ...
            let window2Path = await newComic(randomday, randomday, "C:\\git\\GARFIELD\\window.jpg");
...
async function randomGarfield()
{
    ...
    while(r === false)
    {
        ...
        let raw = new Date(1978, 5, 19).valueOf() + Math.floor( Math.random() * difference );
...
async function randomWeekday()
{
    ...
    while(r === false)
    {
        ...
        while(date.getDay() == 0)
        {
            raw = new Date(1978, 5, 19).valueOf() + Math.floor( Math.random() * difference );
            date = new Date(raw);
        }
...
async function sendToMainChannel(message)
{
    ...
    client.guilds.cache.get(process.env.GUILD_ID).channels.cache.get(process.env.DAILY_CHANNEL_ID).send(message);
}
